package net.vis4.color 
{
	 ...
	 * 
	 */
	public class PerceptualColor extends EventDispatcher
	{
		/**
		 ...
		 * 
		 * <p>usage example:</p>
		 * <listing>var col:PerceptualColor = new PerceptualColor(PerceptualColor.HSL);
		 ...
		 */
		public function PerceptualColor(mode:String = 'hsl') 
		{
		 ...
		 * <p>example:</p>
		 * <listing>
		 * color = PerceptualColor.fromHSL(60, .5, 1);
		 * color.mode = PerceptualColor.HSV;
		 ...
		 * <p>example:</p>
		 * <listing>
		 * color = PerceptualColor.fromInt(0xFF0000, PerceptualColor.HSB);
		 ...
		 * @mode 
		 */
		public static function fromInt(color:uint, mode:String = 'hsl'):PerceptualColor
		{
			var c:PerceptualColor = new PerceptualColor(mode);
			c.intColor = color;
			return c;
		}
		 ...
		 * @mode 
		 */		
		public static function fromHex(color:String, mode:String = 'hsl'):PerceptualColor
		{
			var c:PerceptualColor = new PerceptualColor(mode);
			c.hexColor = color;
			return c;
		...
		public static function fromRGB(r:uint, g:uint, b:uint, mode:String = 'hsl'):PerceptualColor
		{
			var c:PerceptualColor = new PerceptualColor(mode);
			c.setRGB(r, g, b);
			return c;
		...
		public static function fromHSV(h:Number, s:Number, v:Number, mode:String = 'hsv'):PerceptualColor
		{
			var c:PerceptualColor = new PerceptualColor(mode);
			c.setHSV(h, s, v);
			return c;
		...
		public static function fromHSI(h:Number, s:Number, i:Number, mode:String = 'hsi'):PerceptualColor
		{
			var c:PerceptualColor = new PerceptualColor(mode);
			c.setHSI(h, s, i);
			return c;
		...
		public static function fromHSL(h:Number, s:Number, l:Number, mode:String = 'hsl'):PerceptualColor
		{
			var c:PerceptualColor = new PerceptualColor(mode);
			c.setHSL(h, s, l);
			return c;
		...
		public static function fromHSB(h:Number, s:Number, b:Number, mode:String = 'hsb'):PerceptualColor
		{
			var c:PerceptualColor = new PerceptualColor(mode);
			c.setHSB(h, s, b);
			return c;
		 ...
		 * <listing>
		 * color = PerceptualColor.fromHSL(0, 1, .5); // starting from red
		 ...
		 * @return
		 */
		public function clone():PerceptualColor
		{
			return PerceptualColor.fromInt(_u, _mode);
		}
	}
